(function(){
  ...
  */
  ...
  out$.generate_interventions_for_domain = generate_interventions_for_domain = async function(domain){
    var goal_name, goal_info, default_interventions, ref$, generic_interventions, all_intervention_info, video_interventions, new_intervention_info_list, i$, len$, generic_intervention, intervention_info, fixed_intervention_name, make_absolute_path, default_enabled_interventions;
  ...
  */
  select_subset_of_available_interventions = function(intervention_info_list_all){
    var goal_to_intervention_info_list, i$, len$, intervention_info, goal_name, default_enabled_interventions, intervention_info_list, available_default_interventions, num_interventions_chosen, chosen_interventions, intervention_name;
  ...
  out$.get_interventions = get_interventions = async function(){
    var cached_get_interventions, interventions_to_goals, intervention_name_to_info, interventions_list, output, intervention_info_list, default_enabled_interventions, cached_default_enabled_interventions, i$, len$, intervention_info, extra_get_interventions_text, extra_get_interventions, intervention_name;
    cached_get_interventions = localStorage.getItem('cached_get_interventions');
    interventions_to_goals = (await goal_utils.get_interventions_to_goals());
